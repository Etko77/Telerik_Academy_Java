...
public class VehicleDealershipRepositoryImpl implements VehicleDealershipRepository {
    ...
    @Override
    public CarImpl createCar(String make, String model, double price, int seats) {
        return new CarImpl(make, model, price, seats);
    }

    @Override
    public MotorcycleImpl createMotorcycle(String make, String model, double price, String category) {
        return new MotorcycleImpl(make, model, price, category);
    }

    @Override
    public TruckImpl createTruck(String make, String model, double price, int weightCapacity) {
        return new TruckImpl(make, model, price, weightCapacity);
    }

    @Override
    public UserImpl createUser(String username, String firstName, String lastName, String password, UserRole userRole) {
